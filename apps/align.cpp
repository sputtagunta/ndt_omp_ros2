...
pcl::PointCloud<pcl::PointXYZ>::Ptr aligner(pcl::Registration<pcl::PointXYZ, pcl::PointXYZ>::Ptr registration, const pcl::PointCloud<pcl::PointXYZ>::Ptr& target_cloud, const pcl::PointCloud<pcl::PointXYZ>::Ptr& source_cloud ) {
...
int main(int argc, char** argv) {
  ...
  *target_cloud = *downsampled;
  ...
  aligned = aligner(gicp_omp, target_cloud, source_cloud);
  ...
  aligned = aligner(ndt, target_cloud, source_cloud);
  ...
  for(int n : num_threads) {
    for(const auto& search_method : search_methods) {
      ...
      aligned = aligner((pcl::Registration<pcl::PointXYZ, pcl::PointXYZ>::Ptr) ndt_omp, target_cloud, source_cloud);
    }
  }
